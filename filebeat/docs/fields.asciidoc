...
[[exported-fields-casdm]]
== CA Service Desk Manager fields

Module for handling CA Service Desk Manager's various logs. Individual filesets handle the different log types.
...
stdlogs are the core set of logs in a CA Service Desk Manager installation


*`casdm.stdlog.timestamp`*::
+
--
type: text
...
Extracted timestamp as a string

--

*`casdm.stdlog.node_name`*::
+
--
type: text
...
CA SDM process related information


*`casdm.stdlog.process.name`*::
+
--
type: text
...
Log message's sender information


*`casdm.stdlog.source_file.name`*::
+
--
type: text
...
Name of the (possibly compiled) file that sent the log message

--

*`casdm.stdlog.source_file.line`*::
+
--
type: long
...
Line number on the log message's sender file

--

*`casdm.stdlog.message`*::
+
--
type: text
...
The actual log message, as is. This can be further refined in filters.
